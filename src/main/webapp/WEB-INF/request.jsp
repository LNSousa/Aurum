    ...
    <div class="container d-flex align-items-center flex-column">
        ...
        <div class="border border-dark-subtle p-5 col-6 bg-white rounded-3">
            <!-- Form -->
               ...
               <h3>Current account balance: $<fmt:formatNumber type="number" maxFractionDigits="2" value="${checking.getBalance()}" /></h3>
               <form action="/process-request" method="post" class="deposit-form">
                   <div class="my-5 d-flex justify-content-around">
                       <div class="form-check">
	                       <input name="action" class="form-check-input" type="radio" value="withdraw"/>
	                       <label class="form-check-label" for="action">Withdraw</label>
                       </div>
                       <div class="form-check">
	                       <input name="action" class="form-check-input" type="radio" value="deposit"/>
	                       <label class="form-check-label" for="action">Deposit</label>
                       </div>
                   </div>
                   <div class="my-3">
